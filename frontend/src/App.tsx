...
import { Activity, TrendingUp, BarChart3, Globe, Menu } from 'lucide-react';
...
function App() {
  const { activeTab, setActiveTab, stats, connected, setConnected } = useStore();
      ...
      <footer className="mt-16 border-t border-gray-800 bg-gray-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-sm text-gray-500">
            ...
            <p className="mt-1">Powered by Prometheus & Grafana</p>
          </div>
        </div>
      </footer>
    </div>
